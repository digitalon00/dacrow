...
<body>
        <section class="dashboard">
            ...
            <div class="dashboard-container">
                ...
                <div class="dashroot">
                    <p>My Dashboard / <span class="dash-root">Manage Orders / in progress</span></p>
                </div>
                <div class="dash-box">
                    <div class="orders_list">
                        ...
                        <div class="orders_table">
                            <table>
                                ...
                                <tbody>
                                    <?php
                                    $select_order=$conn->prepare("SELECT * FROM `orders` WHERE status='in progress' ORDER BY user_id DESC");
                                    ...
                                    if ($select_order->rowCount()>0) {
                                        while ($fetch_order = $select_order -> fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            <td><form action="" method="post">
                                                ...
                                                <button type="submit" name="accept" class="accept_btn" onclick="return confirm('accept this order ??')">accept</button>
