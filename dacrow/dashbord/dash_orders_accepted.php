...
<body>
        <section class="dashboard">
            ...
            <div class="dashboard-container">
                ...
                <div class="dashroot">
                    <p>My Dashboard / <span class="dash-root">Manage Orders / accepted</span></p>
                </div>
                <div class="dash-box">
                    <div class="orders_list">
                        ...
                        <div class="orders_table">
                            <table>
                                ...
                                <tbody>
                                    <?php
                                    $select_order=$conn->prepare("SELECT * FROM `orders` WHERE status='accepted' ORDER BY user_id DESC");
                                    ...
                                    if ($select_order->rowCount()>0) {
                                        while ($fetch_order = $select_order -> fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            <td><form action="" method="post">
                                                ...
                                                <button type="submit" name="delivered" class="delivered_btn" onclick="return confirm('the order is delivered ??')">delivered</button>
