<?php
    ...
    if(isset($_POST['back_to_delivered'])){
        $order_id = $_POST['order_id'];
        $order_id = filter_var($order_id,FILTER_SANITIZE_STRING);
...
<body>
        <section class="dashboard">
            ...
            <div class="dashboard-container">
                ...
                <div class="dashroot">
                    <p>My Dashboard / <span class="dash-root">Manage Orders / History</span></p>
                </div>
                <div class="dash-box">
                    <div class="orders_list">
                        ...
                        <div class="orders_table">
                            <table>
                                ...
                                <tbody>
                                    <?php
                                    $select_order=$conn->prepare("SELECT * FROM `orders` WHERE status='done' ORDER BY user_id DESC");
                                    ...
                                    if ($select_order->rowCount()>0) {
                                        while ($fetch_order = $select_order -> fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            <td><form action="" method="post">
                                                ...
                                                <button type="submit" name="back_to_delivered" class="delivered_btn" onclick="return confirm('back to delivered ??')">back to delivered</button>
