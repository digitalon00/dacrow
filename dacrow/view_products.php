...
<head>
    ...
    <title>Dacrow - product details</title>
            ...
            <?php
                if(isset($_GET['pid'])){
                    ...
                    if($select_products->rowCount()>0){
                        ...
                        ?>
                        <form action="" method="post" class="details-products-form" >
                            <a href="#" onclick="goBack()"><span class="back"><ion-icon name="arrow-back-outline"></ion-icon>Back</span></a>
                            <img src="imgs/products/<?php echo $fetch_products['image'];?>" alt="">
                            <div class="details-products-container">
                                <div class="products-container-header">
                                    <h5><?php echo $fetch_products['marque'];?></h5>
                                ...
                                <p class="details-p"><span>Details : </span><?php echo $fetch_products['details'];?></p>
